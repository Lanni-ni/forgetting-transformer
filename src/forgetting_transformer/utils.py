    ...
    for module_name, module in model.named_modules():
        ...
        for param_name, param in module.named_parameters(recurse=False):
            ...
            if param in memo:
                ...
                # output layer. Skip duplicates for tied weights.
                # raise ValueError(
                ...
                # )
                logging.info(f"[INFO] Skipping duplicate parameter {param_name} in {module_name} (likely tied weights)")
                continue
            memo.add(param)
            should_decay = None
        ...
        for key in ["token_count", "batch_count", "flop_count"]:
            ...
            for time_type in ["total", "update"]:
                ...
                for recent in [True, False]:
                    ...
                    if key == "flop_count" and self.available_flops is not None:
