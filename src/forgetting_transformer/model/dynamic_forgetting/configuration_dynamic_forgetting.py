...
class DynamicForgettingConfig(PretrainedConfig):
    model_type = 'dynamic_forgetting'
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_dynamic_fgate = use_dynamic_fgate
        self.fgate_num_epochs = fgate_num_epochs
        self.fgate_initial_lambda = fgate_initial_lambda
        self.fgate_decay_rate = fgate_decay_rate
